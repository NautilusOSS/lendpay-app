    ...
    <main className="min-h-screen w-full px-6 pb-20">
      ...
      <div className="max-w-xl mx-auto mt-10">
        <BetaIntakeForm
          ...
          description="Submit your details. A nonrefundable signup fee of $1.00 USDC on Base (x402) completes when the workflow accepts your transaction. Beta signup does not guarantee access."
